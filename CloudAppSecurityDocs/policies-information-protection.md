...
2.  Em **método de inspeção**, selecione **DCS (serviço de classificação de dados)** e, em **Selecionar tipo** , selecione um ou mais tipos de informações que estejam em conformidade com a conformidade do GDPR, por exemplo: número do cartão de débito da UE, número de licença dos drivers da UE, UE número de identificação nacional, número do Passport da UE, NSS da UE, número de identificação do imposto da SU.
