...
– Alertas – os alertas podem ser disparados no sistema e propagados por email e mensagem de texto, com base no nível da gravidade. 

– Notificação de email do usuário – as mensagens de email podem ser personalizadas e serão enviadas a todos os proprietários do arquivo em violação. 
...
– Alterar o compartilhamento 
 ...
 – Remover compartilhamento público – permitir o acesso apenas para colaboradores nomeados, por exemplo: Remover acesso público para o G Suite e Remover link direto compartilhado para o Box. 
 ...
 – Remover um parceiro – remover um parceiro específico do arquivo. 
...
– Quarentena 
 ...
 – Colocar em quarentena do administrador – o arquivo é movido para a quarentena na unidade do administrador, e ele precisa aprová-lo. 

– Herdar permissões do pai – essa ação de governança permite remover o conjunto de permissões específicas para um arquivo ou pasta no Office 365 e revertê-las em quaisquer permissões que estejam definidas para a pasta pai.
– Lixeira – mover o arquivo para a pasta da lixeira.
