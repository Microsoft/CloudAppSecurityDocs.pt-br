...
1. Clique na **Integração de interface do usuário da unidade** e preencha as informações a seguir:
    ...
    * **Descrição curta & descrição longa** (opcional): Microsoft Cloud app Security fornece visibilidade dos aplicativos de nuvem, ajudando você a controlar, investigar e controlar o uso de aplicativos de nuvem; proteger dados corporativos; e detectar atividades suspeitas para qualquer aplicativo em nuvem.

    * O Google exige que você carregue pelo menos um ícone do aplicativo. Vá para [https://go.microsoft.com/fwlink/?linkid=862826](https://go.microsoft.com/fwlink/?linkid=862826) para baixar um arquivo ZIP contendo ícones de Cloud app Security. Em seguida, em **ícone do aplicativo**, clique em **selecionar** ao lado da imagem 128x128 e arraste-a para a tela pop-up. Clique em **selecionar** ao lado da imagem 32x32 e arraste-a para a tela pop-up.
...
`https://www.googleapis.com/auth/admin.directory.user`
    ...
    * Clique em **Salvar alterações**.
        ![visibilidade do Google](media/google-visibility.png)
