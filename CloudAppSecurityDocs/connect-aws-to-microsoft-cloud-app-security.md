...
- **Configuração de segurança**: Essa conexão fornece recomendações de segurança fundamentais com base no benchmark do CIS (Center for Internet Security) para AWS.
...
1. Opcional: Adicione marcas ao usuário.
