...
> |----|----|----|------------|
> |HttpRequestFailure: O servidor retornou: 400 Solicitação Inválida: {"error":{"code":"AF20012","message":"A ID de locatário especificada (insira a Tenant_ID aqui) está configurada incorretamente no sistema."|Office 365 |Não foi encontrada nenhuma licença atribuída do Office 365. |Atribua pelo menos uma licença do Office 365 ao seu locatário.| 
...
> |BoxServerException: O usuário não pode acessar esse recurso sem ter uma conta empresarial|Caixa|A conta do Box não é uma conta da empresa.|Atualize sua licença do Box para a versão Enterprise e siga o processo para conectar o Box ao Cloud App Security novamente.|
> |BoxServerException: Não autorizado – Não é possível autorizar com esse serviço|Caixa|O Administrador do Box excluiu o aplicativo do Cloud App Security no Box.|Siga o processo para conectar o Box ao Cloud App Security novamente.|
...
> |SocketTimeoutException: A leitura atingiu o tempo limite|Salesforce|Erro interno|Clique no link “Teste agora” novamente para testar a conexão com o Salesforce.|
...
> |TokenRefreshException: {"error":"invalid_grant","error_description":"AADSTS70002: Erro ao validar credenciais. AADSTS70008: O código de autorização ou o token de atualização fornecido expirou. Envie uma nova solicitação de autorização interativa para esse usuário e recurso.|Office 365|Token expirado|Siga o processo para conectar o Office 365 ao Cloud App Security novamente.|
> |SocketTimeoutException: A leitura atingiu o tempo limite|Office 365|Erro interno|Clique no link “Testar agora” novamente|
