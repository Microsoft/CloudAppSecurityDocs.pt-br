...
> [!NOTE]
> A opção de adicionar o Azure Sentinel não estará disponível se você tiver executado anteriormente a integração.
...
| UserName | Cadeia de caracteres | Nome do usuário | `Raegan@contoso.com` |
...
1. Em Power BI, importe consultas do Sentinela do Azure para dados de Cloud App Security. Para obter mais informações, consulte [importar Azure monitor dados de log em Power bi](/azure/azure-monitor/platform/powerbi).
