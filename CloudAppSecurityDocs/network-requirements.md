...
description: Este artigo descreve os endereços IP e as portas que você precisa abrir para trabalhar com Cloud App Security.
keywords: ''
author: shsagir
ms.author: shsagir
manager: shsagir
...
Alguns dos requisitos abaixo dependem de qual data center você está conectado.

Para ver a qual data center você está se conectando, execute as seguintes etapas:

1. No portal de Cloud App Security, clique no **ícone de ponto de interrogação** na barra de menus. Em seguida, selecione **sobre**.

    ![clique em sobre](media/about-menu.png)

2. Na tela Cloud App Security versão, você pode ver a região e a data center.
...
Além disso, os seguintes itens devem estar na lista de permissões, dependendo de qual data center você usar:
...
> |DOS EUA 2|13.80.125.22<br />20.36.222.59<br />20.36.222.60<br />40.74.1.235<br />40.74.6.204<br />51.143.58.207<br />52.137.89.147<br />52.183.75.62<br />52.184.165.82|\*. us2.portal.cloudappsecurity.com|
...
> [!NOTE]
> Em vez de um curinga (\*), você pode abrir apenas sua URL de locatário específica, por exemplo, com base na captura de tela acima, você pode abrir: mod244533.us.portal.cloudappsecurity.com
...
> |DOS EUA 2|13.80.125.22<br />20.36.222.59<br />20.36.222.60<br />40.74.1.235<br />40.74.6.204<br />51.143.58.207<br />52.137.89.147<br />52.183.75.62<br />52.184.165.82|
...
> [!NOTE]
> Se você não especificou um proxy ao configurar o agente SIEM Cloud App Security, precisará permitir conexões http http://ocsp.msocsp.com/ e ocsp.digicert.com na porta 80. Isso é usado para verificar o status de revogação de certificado quando você se conecta ao portal de Cloud App Security.

## <a name="app-connector"></a>Conector de aplicativos

Para que alguns aplicativos de terceiros sejam acessados pelo Cloud App Security, esses endereços IP podem ser usados. Os endereços IP permitem Cloud App Security coletar logs e fornecer acesso ao console do Cloud App Security.

> [!NOTE]
>Você pode ver esses endereços IP nos logs de atividades do fornecedor porque Cloud App Security executa ações de governança e verificações desses endereços IP.

Para se conectar a aplicativos de terceiros, habilite Cloud App Security para se conectar a partir destes endereços IP:
...
> |DOS EUA 2|13.68.76.47<br />20.36.222.59<br />20.36.222.60<br />40.67.152.91<br />40.67.154.160<br />40.67.155.146<br />40.67.159.55<br />40.84.2.83<br />40.84.4.119<br />40.84.4.93|52.184.165.82<br />52.232.224.227<br />52.232.225.84<br />104.46.116.211<br />104.46.116.211<br />104.46.121.72<br />104.46.121.72<br />104.46.122.189<br />104.42.54.148<br />104.46.122.189<br />|
...
## <a name="third-party-dlp-integration"></a>Integração de DLP de terceiros

Para permitir que Cloud App Security enviem dados por meio de seu stunnel para o servidor ICAP, abra o firewall DMZ para esses endereços IP com um número de porta de origem dinâmico.

1. **Endereços de origem** -esses endereços devem estar na lista de permissões, conforme listado acima, para aplicativos de terceiros do conector de API
2. **Porta TCP de origem** -dinâmica
3. **Endereço (s) de destino** -um ou dois endereços IP do stunnel conectados ao servidor ICAP externo
...
Para se conectar a aplicativos de terceiros e integrá-lo a soluções de DLP externas, habilite Cloud App Security para se conectar a partir destes endereços IP:
...
> |DOS EUA 2|20.36.222.59<br />20.36.222.60<br />40.67.152.91<br />40.67.154.160<br />40.67.155.146<br />40.67.159.55<br />40.84.2.83<br />40.84.4.119<br />40.84.4.93|52.184.165.82<br />52.232.224.227<br />52.232.225.84<br />104.46.116.211<br />104.46.116.211<br />104.46.121.72<br />104.46.121.72<br />104.46.122.189<br />104.46.122.189|
...
## <a name="mail-server"></a>Servidor de email

Para habilitar as notificações a serem enviadas do modelo e das configurações padrão, adicione esses endereços IP à lista de permissões anti-spam. Os endereços IP de email dedicados Cloud App Security são:
...
Se você quiser personalizar a identidade do remetente do email, Microsoft Cloud App Security habilitar a personalização usando o MailChimp®, um serviço de email de terceiros. Para fazê-lo funcionar, no portal de Microsoft Cloud App Security, vá para **configurações**. Selecione **configurações de email** e examine os termos de serviço e a política de privacidade do MailChimp. Em seguida, dê permissão à Microsoft para usar o MailChimp em seu nome.
...
Para habilitar Cloud Discovery recursos usando um coletor de logs e detectar sombra de ti em sua organização, abra os seguintes itens:
...
- Permitir que o coletor de logs inicie o tráfego de saída para o armazenamento de BLOBs do Azure na porta 443:

  | Data Center |                        URL                                 |
  |-------------|------------------------------------------------------------|
  |     US1     | https:\//adaprodconsole.blob.core.windows.net/             |
  |     DOS EUA 2     | https:\//prod03use2console1.blob.core.windows.net/         |
...
> [!NOTE]
>
> - Se o firewall exigir uma lista de acesso a endereços IP estáticos e não oferecer suporte a listas de permissões com base na URL, permita que o coletor de logs inicie o tráfego de saída para os [intervalos de IP do datacenter Microsoft Azure](https://www.microsoft.com/download/details.aspx?id=41653) na porta 443.
>- Permitir que o coletor de logs inicie o tráfego de saída para o portal de Cloud App Security.
>- Se você não especificou um proxy ao configurar o coletor de logs, precisará permitir conexões http http://ocsp.msocsp.com/ e ocsp.digicert.com na porta 80. Isso é usado para verificar o status de revogação de certificado quando você se conecta ao portal de Cloud App Security.
