...
2. Para cada alerta, você precisa investigar e determinar a natureza da violação e a resposta necessária.
    ...
    - Há três tipos de violações com os quais você precisará lidar ao investigar os alertas:
       ...
       - **Violações graves** – violações graves exigem resposta imediata.  
     *Exemplos:*
...
|Novo local|Um alerta informativo sobre o acesso a um aplicativo conectado de um novo local e é disparado apenas uma vez por país/região.|Investigue a atividade do usuário específico.|
