...
Se você integrou o Microsoft defender ATP com o Cloud App Security e não vê os resultados da integração – não há um relatório de **usuários do ponto de extremidade Win10** -Verifique se os computadores aos quais você está se conectando são Windows 10 versão 1809 ou posterior e se você esperou as duas horas necessárias antes de os dados serem acessíveis.
