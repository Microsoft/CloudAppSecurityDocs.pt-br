...
| Atividades/Alertas |        Rótulo de > de CS\<X        |        Cada rótulo tem um significado diferente, mas o rótulo em si é autoexplicativo; por exemplo, targetObjects (objetos de destino).        |
