...
## <a name="step-1-add-azure-ad-apps-in-cloud-app-security"></a>Etapa 1: Adicionar os aplicativos do Azure AD ao Cloud App Security  
...
## <a name="step-2-test-the-deployment"></a>Etapa 2: Testar a implantação
